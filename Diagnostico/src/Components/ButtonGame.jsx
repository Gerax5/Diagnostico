...
const ButtonGame = ({backgroundColor, shadowColor, children, height, width, _style}) =>{
    ...
    return (
        <TouchableHighlight onPress={showAlert} onPressIn={onPressIn} onPressOut={onPressOut} underlayColor="transparent">
